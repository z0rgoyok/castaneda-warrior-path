const translations = {
  ru: {
    ...
    p2_psych: "Это эго-децентрация — ключевой навык в когнитивной терапии. Чрезмерная зацикленность на себе («что обо мне подумают», «меня обидели», «я заслуживаю лучшего») — главный источник тревоги и депрессии. Снижение фокуса на себе освобождает огромное количество умственных ресурсов и снижает навязчивые мысли.",
    ...
    p3_psych: "Социальная психология называет это «освобождением от ролевых ожиданий». Когда окружающие знают твою историю, они держат тебя в рамках: «ты всегда был таким». Это создаёт самосбывающееся пророчество и мешает личностному росту. Меньше информации о себе — больше свободы меняться.",
    ...
    p4_psych: "Это про здоровые границы и профилактику выгорания. Постоянная доступность (24/7 онлайн, мгновенные ответы) истощает нервную систему и создаёт зависимость от внешнего одобрения. Установка границ — базовый навык психогигиены, который защищает энергетический ресурс.",
    ...
    p9_psych: "Это упражнение на переключение внимания — базовый навык осознанности. Фокусировка на тенях вместо объектов требует сознательного усилия, что выводит из режима автопилота и тренирует способность управлять вниманием.",
    ...
    p10_psych: "Это интероцепция — осознание телесных ощущений. Тело знает, где ему хорошо, до того как это осознаёт разум. Практика нахождения «своего места» развивает телесную осознанность и создаёт безопасное пространство для регуляции нервной системы.",
    ...
    p11_psych: "Осознанные сновидения изучаются нейронаукой и используются в терапии (особенно для работы с кошмарами и ПТСР). Способность осознавать себя во сне развивает навыки наблюдения за своим мышлением, которые переносятся в бодрствование: осознание автоматических реакций, привычных схем мышления.",
  ...
  uk: {
    ...
    p2_psych: "Це его-децентрація — ключова навичка в когнітивній терапії. Надмірне зосередження на собі — головне джерело тривоги і депресії. Зниження фокусу на собі звільняє величезну кількість розумових ресурсів.",
    ...
    p4_psych: "Це про здорові кордони та профілактику вигорання. Постійна доступність виснажує нервову систему і створює залежність від зовнішнього схвалення.",
    ...
    p9_psych: "Це вправа на переключення уваги — базова навичка усвідомленості. Фокусування на тінях виводить з режиму автопілота.",
    ...
    p11_psych: "Усвідомлені сновидіння вивчаються нейронаукою і використовуються в терапії. Здатність усвідомлювати себе уві сні розвиває навички спостереження за власним мисленням.",
    ...
    p12_psych: "Це те, що Маслоу називав «піковими переживаннями» — моменти, коли звичайне сприйняття «провалюється» і ти бачиш світ по-новому.",
